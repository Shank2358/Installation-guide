...
typedef struct _AlgorithmCOM_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } AlgorithmCOM_MIDL_TYPE_FORMAT_STRING;

typedef struct _AlgorithmCOM_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } AlgorithmCOM_MIDL_PROC_FORMAT_STRING;

typedef struct _AlgorithmCOM_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } AlgorithmCOM_MIDL_EXPR_FORMAT_STRING;
...
extern const AlgorithmCOM_MIDL_TYPE_FORMAT_STRING AlgorithmCOM__MIDL_TypeFormatString;
extern const AlgorithmCOM_MIDL_PROC_FORMAT_STRING AlgorithmCOM__MIDL_ProcFormatString;
extern const AlgorithmCOM_MIDL_EXPR_FORMAT_STRING AlgorithmCOM__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO ITirBase_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ITirBase_ProxyInfo;
...
static const AlgorithmCOM_MIDL_PROC_FORMAT_STRING AlgorithmCOM__MIDL_ProcFormatString =
    {
        0,
        {
...
static const AlgorithmCOM_MIDL_TYPE_FORMAT_STRING AlgorithmCOM__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    AlgorithmCOM__MIDL_ProcFormatString.Format,
...
/* Object interface: ITirBase, ver. 0.0,
   GUID={0x0E05ABD7,0x9661,0x404F,{0x89,0xF5,0xE3,0xD1,0xEF,0x7C,0x3C,0x6C}} */

#pragma code_seg(".orpc")
static const unsigned short ITirBase_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ITirBase_ProxyInfo =
    {
    &Object_StubDesc,
    AlgorithmCOM__MIDL_ProcFormatString.Format,
    &ITirBase_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ITirBase_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    AlgorithmCOM__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _ITirBaseProxyVtbl = 
{
    &ITirBase_ProxyInfo,
    &IID_ITirBase,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* ITirBase::Add */
};


static const PRPC_STUB_FUNCTION ITirBase_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _ITirBaseStubVtbl =
{
    &IID_ITirBase,
    &ITirBase_ServerInfo,
    8,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    AlgorithmCOM__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _AlgorithmCOM_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    ( CInterfaceProxyVtbl *) &_ITirBaseProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _AlgorithmCOM_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    ( CInterfaceStubVtbl *) &_ITirBaseStubVtbl,
    0
...
PCInterfaceName const _AlgorithmCOM_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    "ITirBase",
    0
...
const IID *  const _AlgorithmCOM_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _AlgorithmCOM_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _AlgorithmCOM, pIID, n)

int __stdcall _AlgorithmCOM_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _AlgorithmCOM, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _AlgorithmCOM, 2, *pIndex )
    
}

const ExtendedProxyFileInfo AlgorithmCOM_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _AlgorithmCOM_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _AlgorithmCOM_StubVtblList,
    (const PCInterfaceName * ) & _AlgorithmCOM_InterfaceNamesList,
    (const IID ** ) & _AlgorithmCOM_BaseIIDList,
    & _AlgorithmCOM_IID_Lookup, 
    2,
    2,
